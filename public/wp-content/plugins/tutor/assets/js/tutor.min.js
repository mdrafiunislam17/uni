(() => {
    var n = {
        ...
        4055: () => {
            window.jQuery(document).ready(function(s) {
                ...
                s(document).on("click", ".tutor-course-review-popup-form .tutor-modal-close-o, .tutor-course-review-popup-form .tutor-review-popup-cancel", function() {
                    var t = s(this).closest(".tutor-modal");
                    var e = t.find('input[name="course_id"]').val();
                    var r = {
                ...
                s(document).on("click", ".tutor_submit_review_btn", function(e) {
                    ...
                    var u = r.find('input[name="course_id"]').val();
                    var l = r.find('input[name="review_id"]').val();
                    ...
                    s.ajax({
                        ...
                        success: function e(t) {
                            ...
                            tutor_toast(l ? c("Updated successfully!", "tutor") : c("Thank You for Rating The Course!", "tutor"), l ? c("Updated rating will now be visible in the course page", "tutor") : c("Your rating will now be visible in the course page", "tutor"), "success");
                            s.ajax({
                                url: _tutorobject.ajaxurl,
                                type: "POST",
                                dataType: "json",
                        ...
                        complete: function e() {
                            t.html(i).removeAttr("disabled").removeClass("is-loading")
                        }
                    })
                });
        ...
        2073: () => {
            (function e() {
                ...
                t.forEach(function(e) {
                    ...
                    var a = e.querySelectorAll("button");
                    a.forEach(function(r) {
                        if (r.dataset.position === n.value) {
                            r.classList.remove("tutor-btn-secondary");
                            r.classList.add("tutor-btn-primary")
                        }
                        r.addEventListener("click", function(e) {
                            var t = r.dataset.position;
                            n.value = t;
                            n.dispatchEvent(new Event("input"));
                            a.forEach(function(e) {
                                return e.classList.remove("tutor-btn-primary")
                            });
                            a.forEach(function(e) {
                                return e.classList.add("tutor-btn-secondary")
                            });
                            r.classList.remove("tutor-btn-secondary");
                            r.classList.add("tutor-btn-primary")
                        })
        ...
        2953: () => {
            (function e() {
                ...
                var l = document.querySelector(".tutor-password-strength-hint .weak");
                var s = document.querySelector(".tutor-password-strength-hint .medium");
                var c = document.querySelector(".tutor-password-strength-hint .strong");
                var r = wp.i18n,
                    d = r.__,
                    n = r._x,
                    a = r._n,
                    ...
                    t.forEach(function(u) {
                        u.addEventListener("input", function(e) {
                            ...
                            if (i.value != "") {
                                ...
                                if (i.value.length <= 3 && (i.value.match(f) || i.value.match(p) || i.value.match(v))) n = 1;
                                if (i.value.length >= 6 && (i.value.match(f) && i.value.match(p) || i.value.match(p) && i.value.match(v) || i.value.match(f) && i.value.match(v))) n = 2;
                                if (i.value.length >= 6 && i.value.match(f) && i.value.match(p) && i.value.match(v)) n = 3;
                                if (n == 1) {
                                    l.classList.add("active");
                                    if (r) {
                                        r.style.display = "block";
                                        r.textContent = d("weak", "tutor")
                                    }
                                }
                                if (n == 2) {
                                    s.classList.add("active");
                                    if (r) {
                                        r.textContent = d("medium", "tutor")
                                    }
                                } else {
        ...
        1323: () => {
            ...
            function e(u) {
                ...
                var i = new Event("tutor_dropdown_closed");
        ...
        8958: (j, e, t) => {
            ...
            function E(c) {
                return function(e) {
                    ...
                    var u = Array.isArray(i) ? _(i, function(e) {
                        return e.test(o)
                    }) : C(i, function(e) {
                        return e.test(o)
                    });
        ...
        7145: e => {
            ...
            function T(e) {
                return typeof e == "symbol" || D(e) && h.call(e) == t
            }
        ...
        9198: function(e, r, n) {
            ! function(e, t) {
            ...
            }(this, function(e, U, r, n, a, o, i, z, W, H, B, Z, Q, V, K, G, $, X, J, ee, te, re, ne, ae, oe, ie, ue, le, se, ce, de, fe, pe, ve, he, me, ye, ge, be, we, ke, xe, Se, Ee, Ce, _e, De, Te, Pe, Oe, Me, Ne, Le, Ae, Ie, je, Fe, Re, Ye, qe, Ue, ze, We) {
                "use strict";
                ...
                var Er = function(e) {
                        ...
                        function i(e) {
                            var a;
                            C(this, i), D(P(a = o.call(this, e)), "renderOptions", function() {
                                var t = a.props.year,
                            ...
                            }), D(P(a), "onChange", function(e) {
                                a.props.onChange(e)
                            }), D(P(a), "handleClickOutside", function() {
                                a.props.onCancel()
                            }), D(P(a), "shiftYears", function(t) {
                            ...
                            }), D(P(a), "incrementYears", function() {
                                return a.shiftYears(1)
                            }), D(P(a), "decrementYears", function() {
                                return a.shiftYears(-1)
                            });
                    ...
                    _r = function(e) {
                        ...
                        function o() {
                            ...
                            return D(P(a = n.call.apply(n, [this].concat(t))), "state", {
                                dropdownVisible: !1
                            }), D(P(a), "renderSelectOptions", function() {
                            ...
                            }), D(P(a), "renderScrollMode", function() {
                    ...
                    Dr = function(e) {
                        ...
                        function o() {
                            ...
                            return D(P(r = a.call.apply(a, [this].concat(t))), "isSelectedMonth", function(e) {
                                return r.props.month === e
                            }), D(P(r), "renderOptions", function() {
                            ...
                            }), D(P(r), "onChange", function(e) {
                                return r.props.onChange(e)
                            }), D(P(r), "handleClickOutside", function() {
                    ...
                    Pr = function(e) {
                        ...
                        function o() {
                            ...
                            C(this, o);
                            for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                            return D(P(n = a.call.apply(a, [this].concat(t))), "state", {
                                dropdownVisible: !1
                            }), D(P(n), "renderSelectOptions", function(e) {
                            ...
                            }), D(P(n), "renderSelectMode", function(e) {
                                return m.default.createElement("select", {
                                    value: n.props.month,
                            ...
                            }), D(P(n), "renderReadView", function(e, t) {
                                return m.default.createElement("div", {
                                    key: "read",
                                    style: {
                                        visibility: e ? "visible" : "hidden"
                            ...
                            }), D(P(n), "renderDropdown", function(e) {
                ...
                var Mr = function(e) {
                        ...
                        function r(e) {
                            var n;
                            return C(this, r), D(P(n = t.call(this, e)), "renderOptions", function() {
                            ...
                            }), D(P(n), "handleClickOutside", function() {
                                n.props.onCancel()
                            }), n.state = {
                    ...
                    Ar = function(e) {
                        ...
                        function a() {
                            ...
                            return D(P(c = n.call.apply(n, [this].concat(t))), "dayEl", m.default.createRef()), D(P(c), "handleClick", function(e) {
                                ...
                                return n.get(a)
                            }), D(P(c), "isInRange", function() {
                                var e = c.props,
                                    t = e.day,
                                    r = e.startDate,
                                    n = e.endDate;
                                return !(!r || !n) && Xt(t, r, n)
                            }), D(P(c), "isInSelectingRange", function() {
                                var e, t = c.props,
                                    r = t.day,
                                    n = t.selectsStart,
                                    a = t.selectsEnd,
                            ...
                            }), D(P(c), "isSelectingRangeStart", function() {
                                var e;
                                ...
                                return F(r, a ? o : n)
                            }), D(P(c), "isSelectingRangeEnd", function() {
                                var e;
                                if (!c.isInSelectingRange()) return !1;
                                var t = c.props,
                                    r = t.day,
                            ...
                            }), D(P(c), "renderDayContents", function() {
                    ...
                    Ir = function(e) {
                        ...
                        function o() {
                            ...
                            return D(P(t = a.call.apply(a, [this].concat(r))), "handleClick", function(e) {
                    ...
                    Fr = function(e) {
                        ...
                        function a() {
                            ...
                            C(this, a);
                            for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                            return D(P(d = n.call.apply(n, [this].concat(t))), "MONTH_REFS", It(Array(12)).map(function() {
                                return m.default.createRef()
                            })), D(P(d), "isDisabled", function(e) {
                                return rr(e, d.props)
                            }), D(P(d), "isExcluded", function(e) {
                                return nr(e, d.props)
                            }), D(P(d), "handleDayClick", function(e, t) {
                                d.props.onDayClick && d.props.onDayClick(e, t, d.props.orderInDisplay)
                            }), D(P(d), "handleDayMouseEnter", function(e) {
                                d.props.onDayMouseEnter && d.props.onDayMouseEnter(e)
                            }), D(P(d), "handleMouseLeave", function() {
                                d.props.onMouseLeave && d.props.onMouseLeave()
                            }), D(P(d), "isRangeStartMonth", function(e) {
                                var t = d.props,
                                    r = t.day,
                                    n = t.startDate,
                                    a = t.endDate;
                                return !(!n || !a) && j(S.default(r, e), n)
                            }), D(P(d), "isRangeStartQuarter", function(e) {
                                var t = d.props,
                                    r = t.day,
                                    n = t.startDate,
                                    a = t.endDate;
                                return !(!n || !a) && $t(l.default(r, e), n)
                            }), D(P(d), "isRangeEndMonth", function(e) {
                                var t = d.props,
                                    r = t.day,
                                    n = t.startDate,
                                    a = t.endDate;
                                return !(!n || !a) && j(S.default(r, e), a)
                            }), D(P(d), "isRangeEndQuarter", function(e) {
                                var t = d.props,
                                    r = t.day,
                                    n = t.startDate,
                                    a = t.endDate;
                                return !(!n || !a) && $t(l.default(r, e), a)
                            }), D(P(d), "isWeekInMonth", function(e) {
                                var t = d.props.day,
                                    r = Ke.default(e, 6);
                                return j(e, t) || j(r, t)
                            }), D(P(d), "isCurrentMonth", function(e, t) {
                                return w.default(e) === w.default(N()) && t === b.default(N())
                            }), D(P(d), "isSelectedMonth", function(e, t, r) {
                                return b.default(e) === t && w.default(e) === w.default(r)
                            }), D(P(d), "isSelectedQuarter", function(e, t, r) {
                                return nt.default(e) === t && w.default(e) === w.default(r)
                            }), D(P(d), "renderWeeks", function() {
                            ...
                            }), D(P(d), "onQuarterClick", function(e, t) {
                                d.handleDayClick(Kt(l.default(d.props.day, t)), e)
                            }), D(P(d), "getMonthClassNames", function(e) {
                                var t = d.props,
                                    r = t.day,
                                    n = t.startDate,
                                    a = t.endDate,
                            ...
                            }), D(P(d), "getQuarterClassNames", function(e) {
                                var t = d.props,
                                    r = t.day,
                                    n = t.startDate,
                                    a = t.endDate,
                    ...
                    Rr = function(e) {
                        ...
                        function a() {
                            ...
                            C(this, a);
                            for (var e = arguments.length, t = new Array(e), r = 0; r < e; r++) t[r] = arguments[r];
                            return D(P(p = n.call.apply(n, [this].concat(t))), "state", {
                                height: null
                            }), D(P(p), "handleClick", function(e) {
                            ...
                            }), D(P(p), "isSelectedTime", function(e, t, r) {
                                return p.props.selected && t === g.default(e) && r === h.default(e)
                            }), D(P(p), "liClasses", function(e, t, r) {
                ...
                D(Rr, "calcCenterPosition", function(e, t) {
                ...
                var Yr = function(e) {
                        ...
                        function r(e) {
                            var i;
                            return C(this, r), D(P(i = t.call(this, e)), "YEAR_REFS", It(Array(i.props.yearItemNumber)).map(function() {
                                return m.default.createRef()
                            })), D(P(i), "isDisabled", function(e) {
                                return rr(e, i.props)
                            }), D(P(i), "isExcluded", function(e) {
                                return nr(e, i.props)
                            }), D(P(i), "updateFocusOnPaginate", function(e) {
                                var t = function() {
                                    this.YEAR_REFS[e].current.focus()
                                }.bind(P(i));
                                window.requestAnimationFrame(t)
                            }), D(P(i), "handleYearClick", function(e, t) {
                                i.props.onDayClick && i.props.onDayClick(e, t)
                            }), D(P(i), "handleYearNavigation", function(e, t) {
                                var r = i.props,
                                    n = r.date,
                                    a = r.yearItemNumber,
                            ...
                            }), D(P(i), "isSameDay", function(e, t) {
                                return F(e, t)
                            }), D(P(i), "isCurrentYear", function(e) {
                                return e === w.default(N())
                            }), D(P(i), "isKeyboardSelected", function(e) {
                            ...
                            }), D(P(i), "onYearClick", function(e, t) {
                                var r = i.props.date;
                                i.handleYearClick(Vt(it.default(r, t)), e)
                            }), D(P(i), "onYearKeyDown", function(e, t) {
                                var r = e.key;
                            ...
                            }), D(P(i), "getYearClassNames", function(e) {
                                var t = i.props,
                                    r = t.minDate,
                                    n = t.maxDate,
                                    a = t.selected;
                            ...
                            }), D(P(i), "getYearTabIndex", function(e) {
                    ...
                    qr = function(e) {
                        ...
                        function r(e) {
                            var o;
                            return C(this, r), D(P(o = t.call(this, e)), "onTimeChange", function(e) {
                                o.setState({
                                    time: e
                                });
                                var t = new Date;
                                t.setHours(e.split(":")[0]), t.setMinutes(e.split(":")[1]), o.props.onChange(t)
                            }), D(P(o), "renderTimeInput", function() {
                                var e = o.state.time,
                                    t = o.props,
                                    r = t.date,
                                    n = t.timeString,
                ...
                var zr = ["react-datepicker__year-select", "react-datepicker__month-select", "react-datepicker__month-year-select"],
                    Wr = function(e) {
                        ...
                        function r(e) {
                            var f;
                            return C(this, r), D(P(f = t.call(this, e)), "handleClickOutside", function(e) {
                                f.props.onClickOutside(e)
                            }), D(P(f), "setClickOutsideRef", function() {
                                return f.containerRef.current
                            }), D(P(f), "handleDropdownFocus", function(e) {
                                (function() {
                            ...
                            }), D(P(f), "handleMonthChange", function(e) {
                            ...
                            }), D(P(f), "handleMonthYearChange", function(e) {
                                f.handleYearChange(e), f.handleMonthChange(e)
                            }), D(P(f), "changeYear", function(r) {
                                f.setState(function(e) {
                                    var t = e.date;
                                    return {
                                        date: it.default(t, r)
                            ...
                            }), D(P(f), "changeMonthYear", function(r) {
                                f.setState(function(e) {
                                    var t = e.date;
                                    return {
                            ...
                            }), D(P(f), "formatWeekday", function(e, t) {
                            ...
                            }), D(P(f), "renderPreviousButton", function() {
                            ...
                            }), D(P(f), "renderNextButton", function() {
                                if (!f.props.renderCustomHeader) {
                                    var e;
                                    switch (!0) {
                                        case f.props.showMonthYearPicker:
                            ...
                            }), D(P(f), "renderCurrentMonth", function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f.state.date,
                            ...
                            }), D(P(f), "renderYearDropdown", function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                                if (f.props.showYearDropdown && !e) return m.default.createElement(_r, {
                            ...
                            }), D(P(f), "renderMonthDropdown", function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                            ...
                            }), D(P(f), "renderMonthYearDropdown", function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] && arguments[0];
                            ...
                            }), D(P(f), "renderTodayButton", function() {
                            ...
                            }), D(P(f), "renderDefaultHeader", function(e) {
                                var t = e.monthDate,
                                    r = e.i;
                                return m.default.createElement("div", {
                            ...
                            }), D(P(f), "renderCustomHeader", function() {
                                var e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : {},
                                    t = e.monthDate,
                                    r = e.i;
                            ...
                            }), D(P(f), "renderYearHeader", function() {
                                var e = f.state.date,
                                    t = f.props,
                                    r = t.showYearPicker,
                            ...
                            }), D(P(f), "renderTimeSection", function() {
                            ...
                            }), D(P(f), "renderInputTimeSection", function() {
                    ...
                    Hr = function(e) {
                        ...
                        return _(n, [{
                            ...
                            key: "render",
                            value: function() {
                                return _t.default.createPortal(this.props.children, this.el)
                            }
                        }]), n
                    }(m.default.Component),
                    Br = function(e) {
                    ...
                    Zr = function(e) {
                        ...
                        function n(e) {
                            var r;
                            return C(this, n), D(P(r = t.call(this, e)), "getTabChildren", function() {
                            ...
                            }), D(P(r), "handleFocusStart", function(e) {
                                var t = r.getTabChildren();
                                t && t.length > 1 && t[t.length - 1].focus()
                            }), D(P(r), "handleFocusEnd", function(e) {
                                var t = r.getTabChildren();
                ...
                var Gr = "Date input not valid.",
                    $r = function(e) {
                        ...
                        function r(e) {
                            var f;
                            return C(this, r), D(P(f = t.call(this, e)), "getPreSelection", function() {
                            ...
                            }), D(P(f), "calcInitialState", function() {
                            ...
                            }), D(P(f), "handleSelect", function(e, t, r) {
                                if (f.setState({
                                        preventFocus: !0
                                    }, function() {
                            ...
                            }), D(P(f), "setSelected", function(e, t, r, n) {
                                var a = e;
                            ...
                            }), D(P(f), "setPreSelection", function(e) {
                            ...
                            }), D(P(f), "handleTimeChange", function(e) {
                            ...
                            }), D(P(f), "onPopperKeyDown", function(e) {
                            ...
                            }), D(P(f), "renderDateInput", function() {
                                var e, t = y.default(f.props.className, D({}, Vr, f.state.open)),
        ...
        4448: (k, e, x) => {
            ...
            function De(e, t, r, n) {
                if (null === t || "undefined" === typeof t || _e(e, t, r, n)) return !0;
                if (n) return !1;
            ...
            function Oe(e, t, r, n) {
                ...
                o || (De(t, r, a, n) && (r = null), n || null === a ? Ce(t) && (null === r ? e.removeAttribute(t) : e.setAttribute(t, "" + r)) : a.mustUseProperty ? e[a.propertyName] = null === r ? 3 === a.type ? !1 : "" : r : (t = a.attributeName, n = a.attributeNamespace, null === r ? e.removeAttribute(t) : (a = a.type, r = 3 === a || 4 === a && !0 === r ? "" : "" + r, n ? e.setAttributeNS(n, t, r) : e.setAttribute(t, r))))
            }
            var Me = /^(.*)[\\\/]/,
            ...
            var _r = n.unstable_UserBlockingPriority,
                Dr = n.unstable_runWithPriority,
                Tr = !0;
            ...
            function Dn() {
                ...
                return _n = a.slice(e, 1 < n ? 1 - n : void 0)
            }
            ...
            function Qn(e, t) {
                if (Bn) return "compositionend" === e || !jn && Wn(e, t) ? (e = Dn(), _n = Cn = En = null, Bn = !1, e) : null;
                switch (e) {
                    case "paste":
                        return null;
                    case "keypress":
            ...
            var Vn = {
                    ...
                    extractEvents: function(e, t, r, n) {
                        ...
                        o ? (Yn && "ko" !== r.locale && (Bn || o !== Un.compositionStart ? o === Un.compositionEnd && Bn && (a = Dn()) : (En = n, Cn = "value" in En ? En.value : En.textContent, Bn = !0)), o = Ln.getPooled(o, t, r, n), a ? o.data = a : (a = Hn(r), null !== a && (o.data = a)), Sn(o), a = o) : a = null;
            ...
            function Da(e, t) {
                ...
                for (n = 0; n < r.length; n++)
                    if (!_a.call(t, r[n]) || !Ca(e[r[n]], t[r[n]])) return !1;
                return !0
            }
            ...
            function Aa(e, t) {
                ...
                return Na && Da(Na, r) ? null : (Na = r, e = u.getPooled(Pa.select, Ma, e, t), e.type = "select", e.target = Oa, Sn(e), e)
            }
            var Ia = {
                    eventTypes: Pa,
            ...
            function Po() {
                if (!xo && null !== wo) {
                    ...
                    try {
                        ...
                        throw null !== wo && (wo = wo.slice(t + 1)), io(fo, _), e
                    } finally {
                        xo = !1
                    }
                }
            ...
            function $o(e, t, r, n, a, o, i) {
                e = e.stateNode;
                return "function" === typeof e.shouldComponentUpdate ? e.shouldComponentUpdate(n, o, i) : t.prototype && t.prototype.isPureReactComponent ? !Da(r, n) || !Da(a, o) : !0
            }
            ...
            function Si() {
                ...
                null === P ? D.memoizedState = P = e : P = P.next = e;
                return P
            }
            ...
            function Ei() {
                ...
                var t = null === P ? D.memoizedState : P.next;
                if (null !== t) P = t, T = e;
                else {
                ...
                if (null !== a) {
                    ...
                    do {
                        ...
                        if (s < bi) {
                            ...
                            s > D.expirationTime && (D.expirationTime = s, jl(s))
            ...
            function Pi(e, t, r, n) {
                ...
                null === t ? (t = {
                    lastEffect: null
                }, D.updateQueue = t, t.lastEffect = e.next = e) : (r = t.lastEffect, null === r ? t.lastEffect = e.next = e : (n = r.next, r.next = e, e.next = n, t.lastEffect = e));
                return e
            }
            ...
            function zi(t, r, n) {
                var e = Eo();
                _o(98 > e ? 98 : e, function() {
                    t(!0)
                });
                _o(97 < e ? 97 : e, function() {
                    var e = l.suspense;
            ...
            function Wi(e, t, r) {
                ...
                t.pending = a;
                o = e.alternate;
                if (e === D || null !== o && o === D) wi = !0, a.expirationTime = bi, D.expirationTime = bi;
                else {
            ...
            function iu(e, t, r, n, a, o) {
                ...
                i = e.child;
                if (a < o && (a = i.memoizedProps, r = r.compare, r = null !== r ? r : Da, r(a, n) && e.ref === t.ref)) return gu(e, t, o);
                t.effectTag |= 1;
                e = os(i, n);
                e.ref = t.ref;
                e.return = t;
            ...
            function uu(e, t, r, n, a, o) {
                return null !== e && Da(e.memoizedProps, n) && e.ref === t.ref && (au = !1, a < o) ? (t.expirationTime = e.expirationTime, gu(e, t, o)) : su(e, t, r, n, o)
            }
            ...
            function El(e, t) {
                ...
                if (null !== e) {
                    var r = Eo();
                    1073741823 === t ? (N & Gu) !== O && (N & (M | $u)) === O ? Tl(e) : (R(e), N === O && _()) : R(e);
            ...
            function R(e) {
                if (0 !== e.lastExpiredTime) e.callbackExpirationTime = 1073741823, e.callbackPriority = 99, e.callbackNode = To(Tl.bind(null, e));
                    ...
                    if (0 === t) null !== r && (e.callbackNode = null, e.callbackExpirationTime = 0, e.callbackPriority = 90);
                        ...
                        t = 1073741823 === t ? To(Tl.bind(null, e)) : Do(n, Dl.bind(null, e), {
            ...
            function Dl(t, e) {
                ...
                if (0 !== r) {
                    ...
                    if (null !== A) {
                        ...
                        R(t);
                        if (t.callbackNode === e) return Dl.bind(null, t)
                    }
                }
                return null
            }
            ...
            function Ll(e, t) {
                do {
                    try {
                        ...
                        gi.current = Hi;
                        if (wi)
                            for (var r = D.memoizedState; null !== r;) {
                                var n = r.queue;
            ...
            function Hl() {
                for (; null !== F;) {
                    ...
                    0 === (e & 512) || hl || (hl = !0, Do(97, function() {
                        Bl();
                        return null
                    }));
                    F = F.nextEffect
            ...
            ve = function(e, t, r, n, a) {
                ...
                N |= 4;
                try {
                    return _o(98, e.bind(null, t, r, n, a))
                } finally {
                    N = o, N === O && _()
                }
            };
        ...
        4203: (j, u) => {
            ...
            function N(e) {
                for (var t = x(_); null !== t;) {
                    ...
                    else if (t.startTime <= e) S(_), t.sortIndex = t.expirationTime, k(C, t);
                    else break;
                    t = x(_)
                }
            }
            ...
            function A(e, t) {
                ...
                try {
                    N(t);
                    for (D = x(C); null !== D && (!(D.expirationTime > t) || e && !c());) {
                        var n = D.callback;
                        if (null !== n) {
                            D.callback = null;
                            T = D.priorityLevel;
                            var a = n(D.expirationTime <= t);
                            t = u.unstable_now();
                            "function" === typeof a ? D.callback = a : D === x(C) && S(C);
                            N(t)
                        } else S(C);
                        D = x(C)
                    }
            ...
            u.unstable_scheduleCallback = function(e, t, r) {
                ...
                a > n ? (e.sortIndex = a, k(_, e), null === x(C) && e === x(_) && (M ? s() : M = !0, l(L, a - n))) : (e.sortIndex = r, k(C, e), O || P || (O = !0, o(A)));
                return e
            };
            u.unstable_shouldYield = function() {
                ...
                N(e);
                var t = x(C);
                return t !== D && null !== D && null !== t && null !== t.callback && t.startTime <= e && t.expirationTime < D.expirationTime || c()
            };
        ...
        2053: (t, r, e) => {
            ...
            function Le(e) {
                ...
                if (s) {
                    ...
                    if (a === ge || (a === he || a === me) && o === I) {
                        b = ye;
                        var _ = d && x === k && k.visualViewport ? k.visualViewport.width : x[E];
                        p -= _ - n.width;
                        p *= l ? 1 : -1
                    }
                }
                ...
                if (l) {
                    var P;
                    return Object.assign({}, D, (P = {}, P[w] = g ? "0" : "", P[b] = y ? "0" : "", P.transform = (k.devicePixelRatio || 1) <= 1 ? "translate(" + p + "px, " + h + "px)" : "translate3d(" + p + "px, " + h + "px, 0)", P))
                }
                return Object.assign({}, D, (t = {}, t[w] = g ? h + "px" : "", t[b] = y ? p + "px" : "", t.transform = "", t))
            }
            ...
            function lt(e) {
                ...
                if (F) {
                    ...
                    var J = _ + K - X - $;
                    var ee = _ + G - X;
                    var te = Se(i ? fe(D, J) : D, _, i ? de(T, ee) : T);
                    h[p] = te;
                    k[p] = te - _
                }
                if (R) {
            ...
            var gt = [_e, Oe, Ie, Re, Ue, ot, st, pt, yt];
            var bt = ce({
                defaultModifiers: gt
            });
            var wt = e(9590);
        ...
        2408: (j, e, t) => {
            ...
            function z(e, t, r) {
                ...
                Array.isArray(e) ? L(e, n, r, function(e) {
                    return e
                }) : null != e && (C(e) && (e = Y(e, a + (!e.key || t && t.key === e.key ? "" : ("" + e.key).replace(_, "$&/") + "/") + r)), n.push(e))
            }
    ...
    (() => {
        ...
        var t = function e(r) {
            ...
            var k = _()(2e3, (0, E["default"])(new Date) + 5, 1);
        ...
        function j(t, e) {
            var r = typeof Symbol !== "undefined" && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = F(t)) || e && t && typeof t.length === "number") {
                    if (r) t = r;
                    var n = 0;
                    var a = function e() {};
                    return {
        ...
        window.addEventListener(_tutorobject.content_change_event, d);
        var f = _e(9013);
        var R = _e(2300);
        var Y = _e(3882);
        ...
        function q(e, t) {
            ...
            var n = (0, f["default"])(t);
            var a = p(r, n);
            var o = Math.abs((0, R["default"])(r, n));
            r.setDate(r.getDate() - a * o);
            var i = Number(p(r, n) === -a);
            var u = a * (o - i);
            return u === 0 ? 0 : u
        }

        function h(e, t) {
            return H(e) || W(e, t) || z(e, t) || U()
        }
        ...
        var V = function e() {
            ...
            var p = function e(t) {
                ...
                }, u ? u > 1 ? "".concat(u, " days selected") : "".concat(u, " day selected") : g("0 day selected", "tutor")), S.createElement("div", {
        ...
        function G(t, e) {
            var r = typeof Symbol !== "undefined" && t[Symbol.iterator] || t["@@iterator"];
            if (!r) {
                if (Array.isArray(t) || (r = X(t)) || e && t && typeof t.length === "number") {
                    if (r) t = r;
                    var n = 0;
                    var a = function e() {};
                    return {
        ...
        jQuery(document).ready(function(o) {
            ...
            o(".tutor-form-submit-through-ajax").submit(function(e) {
                e.preventDefault();
                var r = o(this);
                var t = o(this).attr("action") || window.location.href;
                ...
                o.ajax({
                    ...
                    success: function e(t) {
                        if (t.success) {
                            ...
                            tutor_toast(l("Error!", "tutor"), t.data, "error")
                        }
                    },
                    error: function e(t) {
                        tutor_toast(l("Error!", "tutor"), t.statusText, "error")
                    },
                    complete: function e() {
        ...
        window.tutor_esc_attr = function(e) {
        ...
        window.jQuery(document).ready(function(f) {
            ...
            f(document).on("click", ".tutor-qa-reply button.tutor-btn, .tutor-qa-new button.sidebar-ask-new-qna-submit-btn", function(e) {
                ...
                var l = "" !== n ? tinymce.get(n).getContent() : r.find("textarea").val();
                ...
                f.ajax({
                    ...
                    success: function e(t) {
                        ...
                        if (_tutorobject.tutor_pro_url && tinymce && undefined !== r) {
                            ...
                            f(".tutor-qna-single-question pre").each(function() {
                                var t = f(this),
                                    r = "javascript",
                                    e = t.attr("class").trim().replace("language-", "") || r,
                                    n = null;
                                if (Prism) {
                                    try {
                                        n = Prism.highlight(t.text(), Prism.languages[e], e)
                                    } catch (e) {
                                        n = Prism.highlight(t.text(), Prism.languages[r], r)
                                    }
                                    n ? t.html(n) : null
                                }
                            })
                                    ...
                                    case 16:
                                        ...
                                        if (c) {
                                            if (c.success) {
                                                ...
                                                tutor_toast(p("Failed", "tutor"), p(c.data, "tutor"), "error")
                                            }
                                        } else {
