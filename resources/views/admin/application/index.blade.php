...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        ...
        <a href="{{ route('applications.create') }}" class="btn btn-primary btn-sm shadow-sm">
            <i class="fas fa-plus fa-sm text-white-50"></i> Create Applications
        </a>
    </div>
    ...
    var table = $('#dataTable').DataTable({
        ...
        columns: [
            ...
            { data: 'phone', name: 'phone' },
             {data: 'visa_type',   name: 'visa_type', orderable: false},
            { data: 'action', name: 'action', orderable: false, searchable: false },
        ],
        order: [[0, 'asc']],
    });

       $('#filter-visa-type').change(function () {
                table.draw();
            });
