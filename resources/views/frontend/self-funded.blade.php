...
<div id="wp-main-content" class="clearfix main-page">
  ...
  <div class="custom-breadcrumb text-white text-start py-5"
    ...
    <div class="container position-relative" style="z-index: 2;">
      <div class="py-5">
        <h2 class="display-5 fw-bold text-white mb-3">Self Funded</h2>
        <div class="pb-5">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb mb-0">
              ...
              <li class="breadcrumb-item active" aria-current="page">Self Funded</li>
            </ol>
          </nav>
        </div>
      </div>
    ...
    <div class="row row-cols-1 row-cols-sm-2 g-4">
      ...
      <div class="col">
        <div class="card h-100 border-0  position-relative overflow-hidden bg-transparent">
          <div class="image-wrapper">
            <img
              src="https://fmeducation.co.uk/wp-content/uploads/2024/07/TQUK-Level-3-Diploma-in-Business-Administration.jpg"
              class="card-img-top img-fluid"
              alt="Further Education Level 3 Diploma Courses">
          </div>
          <div class="card-body card-body1 text-center ">
            <h3 class="h5 fw-semibold ">TQUK Level 3 Diploma in Business Administration</h3>
                 <a href="#"
      ...
      <div class="col">
        <div class="card h-100 border-0  position-relative overflow-hidden bg-transparent">
          <div class="image-wrapper">
            <img
              src="https://fmeducation.co.uk/wp-content/uploads/2024/07/TQUK-Level-3-Diploma-in-Adult-Care.jpg"
              class="card-img-top img-fluid"
              alt="Higher Education Level 4 to 7">
          </div>
          <div class="card-body card-body1 text-center ">
            <h3 class="h5 fw-semibold ">TQUK Level 3 Diploma in Adult Care</h3>
              <a href="#"
       ...
       <div class="col">
        <div class="card h-100 border-0  position-relative overflow-hidden bg-transparent">
          <div class="image-wrapper">
            <img
              src="https://fmeducation.co.uk/wp-content/uploads/2024/07/TQUK-Level-4-Certificate-in-Education-and-Training.jpg"
              class="card-img-top img-fluid"
              alt="Higher Education Level 4 to 7">
          </div>
          <div class="card-body card-body1 text-center ">
            <h3 class="h5 fw-semibold ">TQUK Level 4 Certificate in Education and Training</h3>
              <a href="#"
             class="stretched-link" aria-label="Level 4 to 7 Courses"></a>
          </div>
       ...
       <div class="col">
        <div class="card h-100 border-0  position-relative overflow-hidden bg-transparent">
          <div class="image-wrapper">
            <img
              src="https://fmeducation.co.uk/wp-content/uploads/2024/07/TQUK-Level-3-Diploma-in-Supporting-Teaching-and-Learning.jpg"
              class="card-img-top img-fluid"
              alt="Higher Education Level 4 to 7">
          </div>
          <div class="card-body card-body1 text-center ">
            <h3 class="h5 fw-semibold ">TQUK Level 3 Diploma in Supporting Teaching and Learning</h3>
              <a href="#"
             class="stretched-link" aria-label="Level 4 to 7 Courses"></a>
          </div>
