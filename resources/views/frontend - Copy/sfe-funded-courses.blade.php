    ...
    <div class="row row-cols-1 row-cols-sm-2 g-4">
      ...
      <div class="col">
        <div class="card h-100 border-0  position-relative overflow-hidden bg-transparent">
          <div class="image-wrapper">
            <img
              src="https://fmeducation.co.uk/wp-content/uploads/2024/07/Further-Education-Level-3-Diploma-Courses.jpg"
              class="card-img-top img-fluid"
              alt="Further Education Level 3 Diploma Courses">
          </div>
          <div class="card-body card-body1 text-center ">
            <h3 class="h5 fw-semibold ">Further Education Level 3 Diploma Courses</h3>
                 <a href="#"
      ...
      <div class="col">
        <div class="card h-100 border-0  position-relative overflow-hidden bg-transparent">
          <div class="image-wrapper">
            <img
              src="https://fmeducation.co.uk/wp-content/uploads/2024/07/Higher-Education-Level-4-to-7.jpg"
              class="card-img-top img-fluid"
              alt="Higher Education Level 4 to 7">
          </div>
          <div class="card-body card-body1 text-center ">
            <h3 class="h5 fw-semibold ">Higher Education (Level 4 to 7)</h3>
              <a href="#"
